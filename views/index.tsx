...
export function IndexPage() {
    ...
    return (
            <div className="container mx-auto px-4">
               <h1 className="my-4 md:text-5xl uppercase bg-clip-text text-transparent bg-gradient-to-br from-green-300 via-blue-500 to-purple-600 text-3xl font-black text-center">Hono + Vite Todo List</h1>
                ...
                <ul className="space-y-4 mt-8"> 
                    {todoList.map(todo => (
                        <li key={todo.id} className="flex items-center bg-white shadow rounded-md p-4 mb-2 max-w-md mx-auto">
                            <div>
                            ...
                            <button
                                ...
                                onClick={async () => {
                                    const res = await api.todo[':id'].$delete({param: {id: todo.id.toString()}});
                                    const result = await res.json();
                                    if (result.success) {
